...
if test=='Test1'
    DATI= struct(  'name',  test,...
        'domain',           [-1,2;0,1],...
        'exact_sol',        '2*x.*cos(pi*x).*sin(2*pi*y)',...
        'force',            '4*pi*sin(pi*x).*sin(2*pi*y)+10*pi*pi*x.*cos(pi*x).*sin(2*pi*y)',...
        'grad_exact_1',     '2*cos(pi*x).*sin(2*pi*y) - 2*pi*x.*sin(pi*x).*sin(2*pi*y)',...
        'grad_exact_2',     '4*pi*x.*cos(pi*x).*cos(2*pi*y)',...
        'alpha',             0,...
        'beta',              0,...
        'fem',              'P1',...         % Q1 - P1
